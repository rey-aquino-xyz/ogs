...
<div class="container col-10">
    <div class="card shadow-sm rounded-4 bg-light mb-3">
        <div class="card-body">
            ...
            <hr>
            <div class="col-8">
                <h6 class="card-title">Name: <strong>TAMANG, LAILANIE TOMAYAO</strong></h6>
                <h6 class="card-title ">Age: <strong>16</strong></h6>
                <h6 class="card-title ">Sex: <strong>Female</strong></h6>
            </div>
    ...
    <div class="card rounded-4 shadow-sm mb-3">
        <div class="card-body">
            ...
            <hr>
            <h6 class="card-title ">LRN: <strong>{ }</strong></h6>
            <div class="form-check form-switch" data-bs-toggle="tooltip" data-bs-placement="top"
                ...
                <label class="form-check-label" for="flexSwitchCheckChecked">Lock my LRN</label>
            </div>
